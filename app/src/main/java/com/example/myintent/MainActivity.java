...
import static com.example.myintent.R.id.start;
import static com.example.myintent.R.id.tv_result;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "08563619740";
            ...
            case R.id.btn_move_with_result:
                Intent moveForResultIntent = new Intent(MainActivity.this, MoveForResultAcitvity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == MoveForResultAcitvity.RESULT_CODE) {
                int selectedValue = data.getIntExtra(MoveForResultAcitvity.EXTRA_SELECTED_VALUE, 0);
